...
const ai = new GoogleGenAI({ apiKey: process.env.TSUKUYOMI_GEMINI_API_KEY });

// 2. Load the System Instruction / Dialogue text file once
const personalityPath = path.join(__dirname, '../personality/tsukuyomi_personality.txt');
let systemInstruction = "You are Tsukuyomi, a trusted and dependable companion yet resilience.";
...
try {
    ...
    console.error("Could not load tsukuyomi_personality.txt:", error);
}
